...
const SOCIAL_ICONS: Record<string, { path: string; color: string; viewBox?: string }> = {
  ...
  behance: { path: "M22 7h-7v-2h7v2zm.5 1h-8c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5h8c.3 0 .5-.2.5-.5v-2c0-.3-.2-.5-.5-.5zm-4.7 6c-1.1 0-2.1.4-2.8 1.1-.7.7-1.1 1.7-1.1 2.8s.4 2.1 1.1 2.8c.7.7 1.7 1.1 2.8 1.1 1.4 0 2.6-.6 3.4-1.6l-1.5-1c-.5.6-1.1.9-1.9.9-.6 0-1.2-.2-1.6-.6-.4-.4-.6-.9-.6-1.6h5.8v-.4c0-1.1-.4-2-1.1-2.8-.8-.6-1.7-.7-2.5-.7zm-1.1 3.1c.1-.6.3-1.1.7-1.4.4-.4.8-.6 1.4-.6.5 0 1 .2 1.4.5.3.3.6.8.7 1.5h-4.2zm-9.2-3.1h-2v3.7h2c.8 0 1.5-.2 2-.7.5-.5.7-1.1.7-1.9 0-.8-.2-1.4-.7-1.9-.5-.4-1.2-.2-2-.2zm-2-4.5h2c.7 0 1.3-.2 1.8-.6.5-.4.7-.9.7-1.6 0-.7-.2-1.2-.7-1.6-.5-.4-1.1-.6-1.8-.6h-2v4.4zm0-9.5h5.5c2.2 0 3.9.5 5.1 1.6 1.2 1.1 1.8 2.5 1.8 4.4 0 1-.2 1.9-.6 2.7-.4.8-1 1.5-1.7 2 .9.4 1.7 1 2.3 1.8.6.8.9 1.8.9 3 0 2.2-.8 4-2.3 5.3-1.5 1.3-3.6 2-6.3 2h-8.2v-22.8z", color: "#1769FF" },
  dribbble: { path: "M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.324c-.432-.143-2.323-.68-4.725-.312 1.707 4.629 2.399 8.392 2.516 9.204 2.39-1.851 3.914-4.692 4.209-7.892zm-6.024 9.742c-.033-.24-.873-4.134-2.665-8.589-3.129 1.04-5.893 3.115-7.853 6.123C7.4 22.448 9.593 23.42 12 23.42c1.458 0 2.827-.325 4.096-.802zM5.33 19.312c1.815-2.73 4.432-4.614 7.333-5.59l-.01-.022c-.058-.145-.118-.293-.182-.433-.129-.281-.261-.557-.405-.828-3.087 1.141-6.418 1.494-9.608 1.058.145 2.362.9 4.546 2.1 6.143l.024-.038a8.318 8.318 0 0 1 .748-.29zm-.885-10.69c.928-.23 3.931-.826 7.425.15a20.088 20.088 0 0 0-2.345-4.515 10.354 10.354 0 0 0-5.836 2.49 13.96 13.96 0 0 1 .756 1.875zm9.196-5.23c1.233 1.758 2.222 3.704 2.916 5.766 2.06.016 4.396.343 6.133 1.012-.8-3.957-3.327-7.221-6.732-8.731l-.367.545c-.413.626-.872 1.341-1.31 2.072l.019.014c.22.333.456.666.68 1 1.16 1.742 2.16 3.612 2.92 5.58a.519.519 0 0 1 .15 0c-.01 0-.01-.315 0-.472-.73-1.89-1.68-3.66-2.82-5.28l.011-.005a8.318 8.318 0 0 1 .31.848c-.02-.12-.04-.24-.06-.35zm-2.022.02a18.257 18.257 0 0 1 2.215 4.35l.082.023c.31.09.61.19.92.29l.064-.021c.36-.12.72-.25 1.08-.38l.021-.065c-.32-.13-.65-.26-.98-.4l.021-.065a15.437 15.437 0 0 1 1.79-2.36l-.046-.06a10.329 10.329 0 0 0-5.147-1.29z", color: "#EA4C89" },
  ...
  steam: { path: "M12 0C5.373 0 0 5.373 0 12c0 2.825 1.002 5.395 2.645 7.428l4.49-1.848c.08-.03.16-.05.24-.07a2.53 2.53 0 0 1 2.5 1.54c.02.05.04.1.06.15l4.8 2.37c.72.35 1.56.24 2.13-.26l5.12-5.12c.5-.57.61-1.41.26-2.13l-2.43-4.92a2.53 2.53 0 0 1-1.54-2.5c.02-.08.04-.16.07-.24l1.1-1.1a2.6 2.6 0 0 1 .4-1.4C18.4 1.57 15.4 0 12.02 0zm.04 7.64c.5 0 .91.41.91.91 0 .5-.41.91-.91.91-.5 0-.91-.41-.91-.91 0-.5.41-.91.91-.91zM7.22 18.3c-.62 0-1.13-.51-1.13-1.13 0-.17.04-.33.11-.47l3.05-1.25c.14-.06.3-.1.47-.1.62 0 1.13.51 1.13 1.13 0 .17-.04.33-.11.47l-3.05 1.25a1.13 1.13 0 0 1-.47.1zM11.66 21.36a1.1 1.1 0 0 1 0-2.2 1.1 1.1 0 0 1 0 2.2z", color: "#000000" },
  playstation: { path: "M0 16.5c0 1.2 1.7 2.1 3.5 2.4V10.1c-1.8.3-3.5 1.2-3.5 2.4zM24 16.5c0-1.2-1.7-2.1-3.5-2.4V23c1.8-.3 3.5-1.2 3.5-2.5v-4zM6 10.3c0-2 2-3.7 4.5-4.3V4c-3.1.6-5.5 2.5-5.5 4.8v10h1v-8.5zM15.5 5.7c2.5.6 4.5 2.3 4.5 4.3v10h1V8.8c0-2.3-2.4-4.2-5.5-4.8v1.7z", color: "#003087" },
  xbox: { path: "M12 0C5.373 0 0 5.373 0 12c0 2.825 1.002 5.395 2.645 7.428l4.49-1.848c.08-.03.16-.05.24-.07a2.53 2.53 0 0 1 2.5 1.54c.02.05.04.1.06.15l4.8 2.37c.72.35 1.56.24 2.13-.26l5.12-5.12c.5-.57.61-1.41.26-2.13l-2.43-4.92a2.53 2.53 0 0 1-1.54-2.5c.02-.08.04-.16.07-.24l1.1-1.1a2.6 2.6 0 0 1 .4-1.4C18.4 1.57 15.4 0 12.02 0z", color: "#107C10" },
};
...
export function generateVisitorBadgeSVG(total: number, unique: number): string {
  ...
  return `
    <svg width="${totalWidth}" height="28" viewBox="0 0 ${totalWidth} 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <rect width="${totalWidth}" height="28" rx="6" fill="url(#visitor_grad)"/>
      <rect width="${labelWidth}" height="28" rx="6" fill="#0969da"/>
      <path d="M${labelWidth-6} 0h6v28h-6z" fill="#0969da"/> <!-- Square off the middle -->
      
      <g transform="translate(8, 6)">
        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1.105-1.343 2-3 2H5c-1.657 0-3-.895-3-2 0-.732.595-1.358 1.5-1.687V10.15a.75.75 0 0 1 1.5 0v.85h6v-.85a.75.75 0 0 1 1.5 0v1.163c.905.329 1.5.955 1.5 1.687Z" fill="white"/>
      </g>

      <text x="32" y="18" fill="white" font-family="'Segoe UI', Ubuntu, Sans-Serif" font-size="12" font-weight="600">${label}</text>
      <text x="${labelWidth + 10}" y="18" fill="white" font-family="'Segoe UI', Ubuntu, Sans-Serif" font-size="12" font-weight="400">${stats}</text>
    </svg>
  `.trim();
}
export const PIKA_ICONS: Record<string, { main: string, accent: string }> = {
  location: {
    main: "M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z",
    accent: "M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
  },
  portfolio: {
    main: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20ZM2 12h20",
    accent: "M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10Z"
  },
  mail: {
    main: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2Z",
    accent: "m22 6-10 7L2 6"
  },
  working: {
    main: "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",
    accent: "M20 12h.01M4 12h.01M22 20H2a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2Z"
  },
  learning: {
    main: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20",
    accent: "M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2Z"
  },
  collab: {
    main: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",
    accent: "M9 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 14v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"
  }
};

export function generatePikaBadgeSVG(type: string, label: string, theme?: SvgTheme): string {
  const icon = PIKA_ICONS[type.toLowerCase()] || PIKA_ICONS.location;
  const c = getColors(theme);
  const labelWidth = Math.max(label.length * 7 + 44, 80);
  
  const isMonochrome = theme === "monochrome";
  const strokeWidth = isMonochrome ? 2.5 : 2;

  return `
    <svg width="${labelWidth}" height="28" viewBox="0 0 ${labelWidth} 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="${labelWidth}" height="28" rx="14" fill="${c.bg}" stroke="${c.border}" stroke-width="${isMonochrome ? 2 : 1}"/>
      <g transform="translate(8, 6)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="${isMonochrome ? c.accentAlt : 'none'}" stroke="${c.accent}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round">
          <path d="${icon.main}" />
          <path d="${icon.accent}" fill="${isMonochrome ? c.bg : 'none'}" opacity="${isMonochrome ? 1 : 0.4}" />
        </svg>
      </g>
      <text x="32" y="18" fill="${c.text}" font-family="'Segoe UI', Ubuntu, Sans-Serif" font-size="12" font-weight="${isMonochrome ? 700 : 500}">${label}</text>
    </svg>
  `.trim();
}
